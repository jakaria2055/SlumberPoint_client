  ...
  return (
    <form className="">
      <TitleHeader
        ...
        title={"Add Room"}
        subTitle={
          "Lorem ipsum dolor sit, amet consectetur adipisicing elit. Similique quidem voluptas asperiores cupiditate, atque sint?"
        }
      />
      ...
      <div className="w-full flex max-sm:flex-col sm:gap-4 mt-4">
        <div className="flex-1 max-w-48">
          ...
          >
            ...
            <option value="Family Flex">Family Flex</option>
          </select>
        </div>
