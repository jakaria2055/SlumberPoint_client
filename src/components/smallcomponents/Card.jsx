...
function Card({ room, index }) {
  return (
    ...
    >
      ...
      {index % 2 === 0 && (
        <p className="px-3 py-1 absolute top-3 left-3 text-xs bg-[#BBDCE5] text-gray-800 font-medium rounded-full">
          Best Seller
        </p>
      )}
      <div className="p-4 pt-5">
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-1">
            <img src={"/icon/starIconFilled.svg"} alt="starIconFilled" /> 4.5
          </div>
        </div>
