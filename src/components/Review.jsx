...
function Review() {
  return (
    <div className='flex flex-col items-center px-6 md:px-16 lg:px-24 bg-slate-50 pt-10 pb-30'>
        <TitleHeader title={"Real Stories, Real Stays"} subTitle={" Discover authentic experiences shared by our valued guests to help you plan your perfect getaway"} />
