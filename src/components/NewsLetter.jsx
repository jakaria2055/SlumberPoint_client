...
function NewsLetter() {
  return (
    <div className="flex justify-center items-center my-5">
      <div className="flex md:flex-row flex-col border border-gray-500/30 rounded-lg items-center md:items-center justify-between gap-5 text-sm max-w-5xl bg-white p-8">
        <div className="max-w-md w-full">
          <h1 className="text-3xl font-semibold text-gray-700">
            Subscribe to Get Update
          </h1>
          <p className="text-gray-500 mt-2">
            Join our community and get insider access to limited-time offers,
            travel tips, and exclusive savings
          </p>
          <div className="flex items-center gap-4 mt-10">
            ...
            />
            <button className="flex items-center gap-2 bg-[#1C6EA4] hover:bg-[#175680] transition-all px-3 py-2 rounded text-white font-medium">
              Subscribe
              <img src="/icon/sendIcon.svg" alt="send" />
            </button>
          </div>
        </div>
